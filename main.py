...
survive through one night in the woods all alone. The only item in \
your inventory are your fists, but don't worry, you can easily find \
more items to collect and use!")
# delay next paragraph
t.sleep(4)
# explain enemies and tiles
print("\nIn the game, you will be able to move north, south, east, \
and west to explore all 5 tiles efficiently. You will also be given \
several other possible actions in all 5 tiles, as well as several \
enemies to fight, and potentially defeat, or be defeated by.")
# delay next paragraph
t.sleep(5)
# talke about health
print("\nSpeaking of health, you have 15 total health points, which can be \
regained by eating food or drinking water.")
# delay next paragraph
t.sleep(5)
print_map()
# delay next paragraph
...
clearing tile and then 7 hours until dawn. Good luck!")
# delay next paragraph
t.sleep(3)
